...
# -*- coding: utf-8 -*-
"""
Script python permettant l'utilisation d'une Intelligence Artificielle 
...
if __name__ == "__main__" :
    ...
    # Test
    test_file = directory + "/single_prediction/" + sys.argv[1]
    print(int(predict_woman_man(test_file, cnn)))
